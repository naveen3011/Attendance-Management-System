...
#About
def about():
    mess._show(title="About",message="This Attendance System is designed by Naveen kushwaha")

#contact
def contact():
    mess._show(title="Contact Me",message="If you find anything weird or you need any help contact me on 'naveenkushwaha759@gmail.com'")
...
window = tkinter.Tk()
window.title("Attendance Management System (Naveen kushwaha)")
window.iconbitmap("face.ico")
window.geometry("1280x720")
window.resizable(True,True)
window.configure(background='#1b64f5')
...
#main window------------------------------------------------
message3 = tkinter.Label(window, text="Attendance Management System" ,fg="white",bg="#000000" ,width=60 ,height=1,font=('times', 29, ' bold '))
...
clearButton = tkinter.Button(frame1, text="Clear", command=clear, fg="white", bg="red", width=11, activebackground = "white", font=('times', 12, ' bold '))
...
trainImg = tkinter.Button(frame1, text="Save Profile", command=psw, fg="black", bg="green", width=34, height=1, activebackground = "white", font=('times', 16, ' bold '))
...
quitWindow = tkinter.Button(frame2, text="Quit", command=window.destroy, fg="white", bg="red", width=35, height=1, activebackground = "white", font=('times', 16, ' bold '))
